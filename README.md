...
3. Запустить все доступные средства можно при помощи одной команды:
```
poetry run nox
```
4. Эти средства также автоматически запускаются при каждом push в репозиторий. Убедиться в этом можно на вкладке проекта "Actions".